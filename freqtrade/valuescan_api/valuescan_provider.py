...
from freqtrade.valuescan_api.client import ValuScanClient, get_client
...
class ValueScanProvider:
    ...
    def get_kline_history(self, symbol: str, interval: str = "1h", limit: int = 500) -> Dict[str, Any]:
        """
        获取K线历史数据
    ...
    def get_chains(self, symbol: str = "", page: int = 1, page_size: int = 50) -> List[Dict[str, Any]]:
        """
        获取代币所在链信息
...
# 全局实例
_provider: Optional[ValueScanProvider] = None


def get_provider(proxy: Optional[str] = None) -> ValueScanProvider:
